...
// Urbanist is the site's preferred typeface (geometric, friendly). Kept under
// the `--font-geist-sans` var name so globals.css `--font-sans` needs no change.
...
export default async function RootLayout({
  ...
  return (
    <html
      ...
      className={`${urbanist.variable} ${geistMono.variable} h-full antialiased ${resolved}`}

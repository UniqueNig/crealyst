            ...
            <tr>
              <td style="padding:24px 32px;font-size:14px;line-height:1.6;color:#ededef;">
                ...
                <p style="margin:24px 0;">
                  <a href="${escape(resetUrl)}" style="display:inline-block;padding:12px 22px;background:${accentColor};color:#ffffff;border-radius:999px;text-decoration:none;font-size:14px;font-weight:500;">
                    Reset password
                  </a>
                </p>

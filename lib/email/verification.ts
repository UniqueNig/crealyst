            ...
            <tr>
              <td style="padding:24px 32px;font-size:14px;line-height:1.6;color:#ededef;">
                ...
                <p style="margin:24px 0;">
                  <a href="${escape(verifyUrl)}" style="display:inline-block;padding:12px 22px;background:#2d5bff;color:#ffffff;border-radius:999px;text-decoration:none;font-size:14px;font-weight:500;">
                    Verify email
                  </a>
                </p>
